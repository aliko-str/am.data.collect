...
//DONE categories:  "History", "Humor & Entertainment" <-- only 75 out of 100 pages
// FULLY DONE: "Arts & Photography", "Biographies & Memoirs", "Business & Money", "Travel"

//TO BE DONE: 

const amazonCats = ["Sci-Fi & Fantasy", "Education & Teaching", "Romance"].map(function(el){
...
function AmazonBookPiece2(descr, commentArr, size, paperPrice, kindlePrice, hardcPrice, allRatings){
	this.size = size;
