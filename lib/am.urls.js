...
//DONE categories: "Arts & Photography"
//"Arts & Design", "Business & Money", "Education & Teaching", "Travel", "History", "Humor & Entertainment", "Sci-Fi & Fantasy", "Romance"

const amazonCats = ["Biographies & Memoirs"].map(function(el){
...
function AmazonBook(catName, piece1, piece2){
	...
	this.ifKindle = piece2.ifKindle;
	this.ifPaper = piece2.ifPaper; 
...
AmazonBook.getWritableProperties = ['catName', 'url', "title", "rating", "nRatings", "avgPrice", "releaseDateStr", "positionInList", "size", "bestSeller", "pageNum", "ifPaper", "ifKindle"];
...
function AmazonBookPiece2(descr, avgPrice, commentArr, size, ifPaper, ifKindle){
	this.size = size;
	this.ifPaper = ifPaper;
	this.ifKindle = ifKindle;
