...
// FULLY DONE, but no ID saved... : "Education & Teaching", "Romance", "History", "Humor & Entertainment"

//TO BE DONE: "Arts & Photography", "Biographies & Memoirs", "Business & Money"  

const amazonCats = ["Travel", "Sci-Fi & Fantasy"].map(function(el){
...
AmazonBook.getWritableProperties = ['id', 'catName', 'url', "title", "descr", "rating", "nRatings", "releaseDateStr", "positionInList", "size", "bestSeller", "pageNum", "paperPrice", "kindlePrice", "hardcPrice", "r1", "r2", "r3", "r4", "r5"];
